...
import { updateTotal }              from '../../redux/actions/total';
...
class FloatCart extends Component {
  ...
  addProduct = product => {
    const { cartProducts, updateTotal } = this.props;
    ...
    return (
      <div className={classes.join(' ')}>
        ...
        <div className="float-cart__content">
          ...
          <div className="float-cart__landing-container">
            {products}
            {!products.length && (
...
export default connect(
  mapStateToProps,
  { loadCart, updateTotal, removeProduct }
)(FloatCart);
